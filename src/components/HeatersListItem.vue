<template>
  ...
  >
    <div class="top-row d-flex" @click="toggleExpand">
      ...
      <div
        class="on-status ms-4"
        :class="{
          on: isHeaterOn && !heaterIsSwitchingIcon,
          off: !isHeaterOn && !heaterIsSwitchingIcon,
        }"
      >
...
export default {
  ...
  methods: {
    ...
    async switchHeater() {
      ...
      var icon = setTimeout(
        () =>
          (this.heaterIsSwitchingIcon = this.heaterIsSwitching ? true : false),
        300
      );
